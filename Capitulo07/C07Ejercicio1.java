 ...
 * la tabla que se muestra a continuación. Muestra el contenido de todos los 
 * elementos del array. ¿Qué sucede con los valores de los elementos que no han 
 * sido inicializados?
 * 
...
public class C07Ejercicio1 {
  public static void main(String[] args) {
    ...
    for(int n: num) { // Mostrar los valores del array
      System.out.print(n + " | ");
    }
  }
}
